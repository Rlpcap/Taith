...
public class TalkToAllVillagersQuest : QuestGiver
{
    public override void Start()
    {
        ...
        goals.Add(new CollectionGoal(this, "VillagersTalked", "Talk with all the Villagers", false, 0, 3, TypeOfGoal.Item));
        goals.Add(new CollectionGoal(this, "", "End", true, 0, 0, TypeOfGoal.Item));
