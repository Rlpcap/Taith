...
Subshader
{
	...
	Pass
	{
		...
		#pragma shader_feature_local NGSS_PCSS_FILTER_DIR
		#pragma shader_feature_local NGSS_USE_CASCADE_BLENDING
		//#pragma shader_feature_local NGSS_USE_EARLY_BAILOUT_OPTIMIZATION_DIR
		//#pragma shader_feature_local NGSS_USE_BIAS_FADE_DIR
		//#pragma shader_feature_local NGSS_HARD_SHADOWS_DIR
