...
Shader "Ice Shader"
{
	Properties
	{
		...
		_DissolveAmount("Dissolve Amount", Range( -4 , 2)) = 0
		_DissolveMinThreshold("Dissolve Min Threshold", Range( 0 , -2)) = 0
		_DissolveMaxThreshold("Dissolve Max Threshold", Range( 0 , 10)) = 0
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float lerpResult24 = lerp( 1.0 , -1.0 , ( ase_worldPos.y - transform19.y ));
			float LocalPositionGradient27 = ( lerpResult24 + (-1.0 + (0.0 - 0.0) * (1.0 - -1.0) / (1.0 - 0.0)) );
			float4 lerpResult5 = lerp( tex2D( _TextureSample0, uv_TextureSample0 ) , triplanar1 , ( ( tex2D( _DissolveTexture, uv_DissolveTexture ) + (_DissolveMinThreshold + (_DissolveAmount - 0.0) * (_DissolveMaxThreshold - _DissolveMinThreshold) / (1.0 - 0.0)) ) + ( LocalPositionGradient27 * 0.5528846 ) ));
			o.Albedo = lerpResult5.xyz;
			o.Metallic = lerpResult5.x;
			o.Alpha = 1;
		}
...
/*ASEBEGIN
Version=18301
0;107;1906;912;3094.776;852.1949;2.499732;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;30;-689.0819,1451.772;Inherit;False;Property;_DissolveMinThreshold;Dissolve Min Threshold;6;0;Create;True;0;0;False;0;False;0;-1.69;0;-2;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;6;-912.3999,-98.04368;Inherit;True;Property;_TextureSample0;Texture Sample 0;2;0;Create;True;0;0;False;0;False;-1;None;9f7b8ad298e230e4194a6113f15738fe;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;6;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;7;-657.5037,320.9338;Inherit;False;Property;_alpha;alpha;3;0;Create;True;0;0;False;0;False;0;0.6031706;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=C4BA3E9FE4200C095D5B149E67C31EB955A7D7A4