...
Shader "Laurel"
{
	...
	SubShader
	{
		...
		CGPROGRAM
			...
			{
				float2 uv_VineR = IN.texcoord.xy * _VineR_ST.xy + _VineR_ST.zw;
				float4 tex2DNode9 = tex2D( _VineR, uv_VineR );
				
				half4 color = tex2DNode9;
...
/*ASEBEGIN
Version=18301
6;249;1906;734;1386.191;175.997;1;True;True
Node;AmplifyShaderEditor.RangedFloatNode;4;-1638.495,295.8116;Inherit;False;Property;_Speed;Speed;0;0;Create;True;0;0;False;0;False;1;1.26;0;10;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;13;-1047.827,300.4817;Inherit;False;Property;_Amplitud;Amplitud;2;0;Create;True;0;0;False;0;False;1;2;0;10;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=FC8FC9ED3460AF73F3BF98758769FA48EF9F3528