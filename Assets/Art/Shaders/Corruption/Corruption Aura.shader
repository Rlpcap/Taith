...
Shader "Corruption Aura"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float temp_output_23_0 = step( tex2DNode22.r , _SpeadAmount );
			float4 lerpResult25 = lerp( ( tex2D( _Texture, uv_Texture ) * float4( 0.1226415,0.1226415,0.1226415,0 ) ) , ( pow( lerpResult18 , temp_cast_0 ) * 2.0 ) , ( temp_output_23_0 + ( temp_output_23_0 - step( tex2DNode22.r , ( _SpeadAmount / 1.1 ) ) ) ));
...
/*ASEBEGIN
Version=18301
0;0;1920;1019;1058.359;1006.939;1;True;True
Node;AmplifyShaderEditor.SimpleTimeNode;13;-2013.667,210.8061;Inherit;False;1;0;FLOAT;1;False;1;FLOAT;0
Node;AmplifyShaderEditor.TexturePropertyNode;3;-1902.008,-318.7108;Inherit;True;Property;_DistortionMap;DistortionMap;1;0;Create;True;0;0;False;0;False;None;45b7d34a07e91d14f8fd42ca2b072fe0;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.TexturePropertyNode;1;-931.8062,-422.133;Inherit;True;Property;_Mask;Mask;0;0;Create;True;0;0;False;0;False;None;ed200a308c3598c489313a6dd109b644;False;white;Auto;Texture2D;-1;0;1;SAMPLER2D;0
...
Node;AmplifyShaderEditor.ColorNode;16;-455.8044,-576.3982;Inherit;False;Property;_Color2;Color 2;4;0;Create;True;0;0;False;0;False;0,0,0,0;0.5423951,0.4886081,0.5660378,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;17;-448.838,-783.6481;Inherit;False;Constant;_Color1;Color 1;5;0;Create;True;0;0;False;0;False;0.05899113,0.02024741,0.1226415,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StepOpNode;32;176.0133,623.0474;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleSubtractOpNode;35;476.3137,509.6007;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;36;771.3812,453.1971;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
ASEEND*/
//CHKSM=52854FE6ADC304DDC2B75B439F912C9AA582720B