...
Shader "Corruption Aura"
{
	Properties
	{
		...
		_HeatWave("Heat Wave", Range( 0 , 1)) = 0.2535692
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutputStandard o )
		{
			...
			float2 panner40 = ( 1.0 * _Time.y * float2( 0,-1 ) + i.uv_texcoord);
			float4 tex2DNode22 = tex2D( _Mask, ( ( (UnpackNormal( tex2D( _DistortionMap, panner40 ) )).xy * _HeatWave ) + i.uv_texcoord ) );
			float4 temp_cast_1 = (_SpeadAmount).xxxx;
			float4 temp_output_23_0 = step( tex2DNode22 , temp_cast_1 );
			float4 temp_cast_2 = (_SpeadAmount).xxxx;
			float4 temp_cast_3 = (( _SpeadAmount / 1.1 )).xxxx;
			float4 lerpResult25 = lerp( ( tex2D( _Texture, uv_Texture ) * float4( 0.1226415,0.1226415,0.1226415,0 ) ) , ( pow( lerpResult18 , temp_cast_0 ) * 3.0 ) , ( temp_output_23_0 + ( temp_output_23_0 - step( tex2DNode22 , temp_cast_3 ) ) ));
...
/*ASEBEGIN
Version=18301
0;0;1920;1019;1529.751;375.9332;1.508117;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;24;-542.5983,725.8761;Inherit;False;Property;_SpeadAmount;SpeadAmount;7;0;Create;True;0;0;False;0;False;0.6030607;0.63;0;1;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=9D42845126A5C110040FA721A939FFA7127B8617