...
Shader "WindEffect"
{
	...
	SubShader
	{
		...
		{
			float temp_output_16_0 = step( i.uv_texcoord.x , (0.0 + (_step - 0.0) * (1.0 - 0.0) / (_SkillDuration - 0.0)) );
			float2 uv_TexCoord7 = i.uv_texcoord * _Vector1 + ( _Mov + float2( 2,0 ) );
			float2 uv_TexCoord3 = i.uv_texcoord * _Vector1 + _Mov;
			float temp_output_21_0 = ( temp_output_16_0 * saturate( ( tex2D( _Wind, uv_TexCoord7 ).r + tex2D( _Wind, uv_TexCoord3 ).r ) ) );
...
/*ASEBEGIN
Version=18301
288;184;1152;660;1422.09;1037.165;1.959302;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;17;-884.4879,-439.535;Inherit;False;Property;_step;step;4;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;19;-872.2358,-317.1843;Inherit;False;Property;_SkillDuration;SkillDuration;3;0;Create;True;0;0;False;0;False;0;0.11;0;0;0;1;FLOAT;0
...
ASEEND*/
//CHKSM=D43C8350741F7EF1468DE0C6BEA5D843FF202745