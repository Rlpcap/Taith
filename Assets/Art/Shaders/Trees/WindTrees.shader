...
Shader "WindTrees"
{
	...
	SubShader
	{
		...
		void vertexDataFunc( inout appdata_full v, out Input o )
		{
			...
			v.vertex.xyz += ( ( ( temp_output_1_0 * _Vector0 * _Intensity * v.color.r ) + ( temp_output_1_0 * staticSwitch29 * _INt * _Vector0 ) ) + ( ( ( 1.0 - clampResult39 ) * v.texcoord.xy.y ) * ( normalizeResult44 * appendResult48 ) ) );
...
/*ASEBEGIN
Version=18301
14;131;1906;888;1222.246;-127.6346;1;False;True
Node;AmplifyShaderEditor.WorldPosInputsNode;33;-2148.363,1319.241;Inherit;False;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
Node;AmplifyShaderEditor.Vector3Node;32;-2134.421,1124.121;Inherit;False;Property;_PlayerPos;PlayerPos;8;0;Create;True;0;0;False;0;False;0,0,0;31.63797,4.027977,-24.63037;0;4;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3
...
Node;AmplifyShaderEditor.RangedFloatNode;45;-1952.247,1872.963;Inherit;False;Property;_Strength;Strength;9;0;Create;True;0;0;False;0;False;0;0.03;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleAddOpNode;53;-172.1252,539.5395;Inherit;False;2;2;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=18D65034B5B5B0D99F8C1AD1C8DDBB03425E23F2