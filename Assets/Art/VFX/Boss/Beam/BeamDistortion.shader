...
Shader "BeamDistortion"
{
	...
	SubShader
	{
		...
		void surf( Input i , inout SurfaceOutput o )
		{
			...
			float4 temp_output_8_0 = ( tex2D( _MainTex, (lerpResult27*1.2 + panner17) ) * tex2D( _Mask, uv_Mask ) );
			o.Emission = ( i.vertexColor * temp_output_8_0 ).rgb;
...
/*ASEBEGIN
Version=18301
0;573;1920;1019;3013.194;309.9935;1.545474;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;34;-2246.639,36.19275;Inherit;False;Property;_DistScale;DistScale;6;0;Create;True;0;0;False;0;False;5;5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.BreakToComponentsNode;14;-178.9228,123.3284;Inherit;False;COLOR;1;0;COLOR;0,0,0,0;False;16;FLOAT;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4;FLOAT;5;FLOAT;6;FLOAT;7;FLOAT;8;FLOAT;9;FLOAT;10;FLOAT;11;FLOAT;12;FLOAT;13;FLOAT;14;FLOAT;15
...
ASEEND*/
//CHKSM=C0966597324787F8C4487FB9B5798BBF76044042